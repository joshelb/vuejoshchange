...
<div class="card-header">
	...
	<input type="radio" class="btn-check" name="options" id="option4" autocomplete="off" @click="handle('history')">
	<label class="btn btn-dark btn-sm" for="option4">Order-History</label>
